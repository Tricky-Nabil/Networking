...
int main(int argc , char* argv[]){
    ...
    std::string speed_Str = "ns3::ConstantRandomVariable[Constant=" + std::to_string(speed) + "]";
    Config::SetDefault("ns3::RandomWalk2dMobilityModel::Speed" , StringValue(speed_Str));
    ...
    if(graph != -1){
        ...
        if(graph == 0){
            ...
            thorough_put_file << speed << "\t" << thorough_put << endl;
            delivery_ratio_file << speed << "\t" << delivery_ratio << endl;
        }
    }
